...
export default async function CustomDomainFestPage(props: { params: Promise<{ domain: string }> }) {
  ...
  if (!event) {
    // If the domain is not found in the DB, it either isn't configured correctly or was deleted.
    notFound();
  }
  ...
  // If the user landed on the main event page directly, default to showing the first sub-event
