  ...
  return (
    <div className="glass-panel animate-fade-in" style={{ padding: 'var(--spacing-lg)', border: '1px solid rgba(255,255,255,0.05)', marginTop: 'var(--spacing-lg)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: 'var(--spacing-md)', borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '12px' }}>
        ...
        <div>
          <h2 style={{ margin: 0, fontSize: '1.25rem', color: 'white' }}>Customer Control Guideline</h2>
      ...
      <div style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: 1.6 }}>
        ...
        {activeTab === "scratch" && (
          <div className="animate-fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <h3 style={{ color: 'white', marginTop: 0 }}>🃏 Interactive Scratch Cards</h3>
              <span style={{ fontSize: '0.7rem', backgroundColor: 'var(--primary)', color: 'white', padding: '2px 8px', borderRadius: 'var(--radius-full)', fontWeight: 600 }}>NEW FEATURE</span>
            </div>
            <p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '15px' }}>
              <div style={{ backgroundColor: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', padding: '15px', borderRadius: 'var(--radius-md)' }}>
                <h4 style={{ color: 'white', margin: '0 0 10px 0', fontSize: '0.95rem' }}>⚙️ How to use:</h4>
              ...
              <div style={{ backgroundColor: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', padding: '15px', borderRadius: 'var(--radius-md)', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
                {/* Visual Simulation of Scratch Card */}
                <div style={{ width: '120px', height: '80px', borderRadius: 'var(--radius-md)', background: 'linear-gradient(135deg, #4f46e5, #06b6d4)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 800, cursor: 'pointer', border: '2px dashed rgba(255,255,255,0.3)', boxShadow: '0 4px 12px rgba(79, 70, 229, 0.3)' }}>
                  Scratch Here!
                </div>
        ...
        {activeTab === "cards" && (
          <div className="animate-fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <h3 style={{ color: 'white', marginTop: 0 }}>💳 Participant ID Cards</h3>
              <span style={{ fontSize: '0.7rem', backgroundColor: 'var(--primary)', color: 'white', padding: '2px 8px', borderRadius: 'var(--radius-full)', fontWeight: 600 }}>NEW FEATURE</span>
            </div>
            <p>
            ...
            <div style={{ backgroundColor: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', padding: '15px', borderRadius: 'var(--radius-md)', marginTop: '15px' }}>
              <h4 style={{ color: 'white', margin: '0 0 10px 0', fontSize: '0.95rem' }}>⚙️ Printing Procedure:</h4>
              <ul style={{ paddingLeft: '20px', margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <li>Press <kbd style={{ background: '#334155', color: 'white', padding: '2px 6px', borderRadius: '4px', fontSize: '0.8rem' }}>Ctrl + P</kbd> to launch print mode (custom stylesheets optimize layout to fit multiple badges per sheet).</li>
              </ul>
            </div>
          </div>
        )}
        ...
        {activeTab === "sorting" && (
          <div className="animate-fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <h3 style={{ color: 'white', marginTop: 0 }}>📊 Team Priority Sorting</h3>
              <span style={{ fontSize: '0.7rem', backgroundColor: 'var(--primary)', color: 'white', padding: '2px 8px', borderRadius: 'var(--radius-full)', fontWeight: 600 }}>NEW FEATURE</span>
            </div>
            <p>
            ...
            <div style={{ backgroundColor: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', padding: '15px', borderRadius: 'var(--radius-md)', marginTop: '15px' }}>
              <h4 style={{ color: 'white', margin: '0 0 10px 0', fontSize: '0.95rem' }}>⚙️ How it works:</h4>
              <ul style={{ paddingLeft: '20px', margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        {activeTab === "poster" && (
          <div className="animate-fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <h3 style={{ color: 'white', marginTop: 0 }}>🎨 Poster Customizer</h3>
              <span style={{ fontSize: '0.7rem', backgroundColor: 'var(--primary)', color: 'white', padding: '2px 8px', borderRadius: 'var(--radius-full)', fontWeight: 600 }}>NEW FEATURE</span>
            </div>
            <p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '15px' }}>
              ...
              <div style={{ backgroundColor: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.03)', padding: '15px', borderRadius: 'var(--radius-md)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <div style={{ border: '1px solid rgba(255,255,255,0.1)', padding: '10px', borderRadius: 'var(--radius-sm)', background: 'linear-gradient(to right, #1e1b4b, #311042)', color: 'white', fontSize: '0.75rem', textAlign: 'center' }}>
                  <div style={{ fontWeight: 800, color: '#f59e0b', fontSize: '0.9rem' }}>CONGRATULATIONS</div>
                  <div style={{ color: '#94a3b8', fontSize: '0.6rem' }}>Oppana (Girls) Junior Results</div>
                  <div style={{ marginTop: '8px', display: 'flex', justifyContent: 'space-between', padding: '4px 8px', background: 'rgba(255,255,255,0.03)' }}>
